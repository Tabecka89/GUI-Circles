...
public class CircleController3 implements CircleEvents {
	...
	private void readyStageForAppearance(Stage primaryStage) {
		...
		primaryStage.setY(iFinals.CONTROLLER_X_COORDINATE + (circleCounter * iFinals.PROPORTION_INCREMENT_VALUE));
